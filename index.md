...
humandate: "14-18 November, 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Nikita Bernier", "Verena Ras", "Ashar Malik", "Akshita", "Ken"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Tajudeen Akinosho", "Brenden Lesch", "Lwazikazi Maqungo"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["nikita@nithecs.ac.za", "asharjm@bii.a-star.edu.sg", "info@nithecs.ac.za"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
...
<p id="where">
  ...
  The instructors will provide you with the Zoom information you will need to connect to this meeting ahead of the training.
</p>
{% endif %}
